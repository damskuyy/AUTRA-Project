{{-- <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse w-auto show" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../data-log">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../control">
                    ...
                    <span class="nav-link-text ms-1">Control Alat</span>
                </a>
            </li>
            <li class="nav-item">
...
{{-- <aside class="sidebar">
    ...
    <nav class="menu">
        ...
        <a href="{{ url('/control') }}" class="menu-item {{ request()->is('control') ? 'active' : '' }}">
        ...
        <a href="{{ url('/notifikasi') }}" class="menu-item {{ request()->is('notifikasi') ? 'active' : '' }}">
            <span class="menu-icon">🔔</span>
            <span class="menu-text">Notifikasi</span>
            <span class="tooltip">Notifikasi</span>
        </a>
        <a href="{{ url('/manage-user') }}" class="menu-item {{ request()->is('manage-user') ? 'active' : '' }}">
            <span class="menu-icon">👥</span>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ url('/control') }}" class="nav-item">
            <i class="fa-solid fa-sliders"></i>
            <span>Control</span>
        </a>

        <a href="{{ url('/laporan') }}" class="nav-item">
            <i class="fa-solid fa-file-lines"></i>
            <span>Laporan</span>
        </a>

        <a href="{{ url('/notifikasi') }}" class="nav-item">
            <i class="fa-solid fa-bell"></i>
            <span>Notifikasi</span>
        </a>

        <a href="{{ url('/manage-user') }}" class="nav-item">
