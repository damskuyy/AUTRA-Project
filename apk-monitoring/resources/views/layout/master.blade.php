...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="" target="_blank">
                <img src="{{asset('assets/img/logo/logo-autra-nonBG.png')}}" class="navbar-brand-img h-100"
                    alt="main_logo">
        ...
        <div class="collapse navbar-collapse w-auto show" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" data-bs-toggle="collapse" href="#collapsePersetujuan"
                        role="button" aria-expanded="false" aria-controls="collapsePersetujuan">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1 flex-grow-1">Persetujuan</span>
                    </a>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl d-flex align-items-center justify-content-between"
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    ...
                                    <span class="text-white text-sm">Jumlah alat dan bahan yang tersedia</span>
                                </div>
                                <div class="col-4">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    ...
                                    <span class="text-white text-sm">Jumlah alat yang sedang dipinjam</span>
                                </div>
                                <div class="col-4">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    ...
                                    <span class="text-white text-sm">Jumlah barang rusak atau hilang</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropdown text-end mb-6">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    ...
                                    <span class="text-white text-sm">Jumlah siswa/kelas yang sedang diblokir</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropstart text-end mb-6">
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-8 text-start">
                                    ...
                                    <span class="text-white text-sm">Notifikasi terbaru pengajuan peminjaman dan
                                        pemakaian bahan</span>
                                </div>
                                <div class="col-4">
                                    <div class="dropstart text-end mb-6">
                                        <a href="javascript:;" class="cursor-pointer" id="dropdownUsers4"
