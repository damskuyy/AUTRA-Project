<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" target="_blank">
        <img src="{{asset('be/img/logos/logo-autra-nonBG.png')}}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">AUTRA Inventarisasi</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/scan-qr">
            ...
            <span class="nav-link-text ms-1">Scan QR</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/transaksi-massal">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Transaksi Massal</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/peminjaman">
            ...
            <span class="nav-link-text ms-1">Peminjaman Alat</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/riwayat-aktivitas">
            ...
            <span class="nav-link-text ms-1">Riwayat Aktivitas</span>
          </a>
        </li>
        <li class="nav-item">
