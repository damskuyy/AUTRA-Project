  ...
  const skills = [
    {
      ...
      image: "/skill/Elektromekanik.png",
    ...
    },
    {
      ...
      image: "/skill/Sensor&Akuator.png",
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skills.map((skill, index) => (
            ...
            >
              ...
              >
                <div 
                  className="h-full rounded-2xl overflow-hidden shadow-xl hover-lift cursor-pointer"
                  style={{ 
                    background: 'white',
